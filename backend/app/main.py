...
def on_startup():
    if globals.PROD_MODE:
        init_db(db_name="ginrummy_db", collection_name="games")  # your production DB defaults
    else:
        init_db(db_name="test_ginrummy_db", collection_name="test_games")
...
server.include_router(game_router, prefix="/game", tags=["game"])